...
namespace ResearchComputationsTests
{
    ...
    public class SymmPolyToValuesTests
    {
        ...
        public void SymToChoose1()
        {
            ...
            SymmetricPolynomial ex2 = YoungDiagramToSymmPoly.WedgeToSymmetricPolynomial(2);
        ...
        public void SymToChoose2()
        {
            ...
            SymmetricPolynomial ex2 = SymmPolyToValues.ChooseBasisToSymmetric(SymmPolyToValues.SymmetricInChooseBasis(ex));
        ...
        public void CyclicToPolynomialTest1()
        {
            ...
            LaurentPolynomial result = SymmPolyToValues.CyclicPolynomialBasisToPolynomial(allTerms, -5);
        ...
        public void CyclicToPolynomialTest2()
        {
            ...
            LaurentPolynomial result = SymmPolyToValues.CyclicPolynomialBasisToPolynomial(allTerms, -6);
        ...
        public void CyclicToPolynomialTest3()
        {
            ...
            // 
            LaurentPolynomial result = SymmPolyToValues.CyclicPolynomialBasisToPolynomial(allTerms, -8);
        ...
        public void CyclicToPolynomialTest4()
        {
            ...
            LaurentPolynomial result = SymmPolyToValues.CyclicPolynomialBasisToPolynomial(allTerms, -7);
        ...
        public void CyclicToPolynomialTest6()
        {
            ...
            LaurentPolynomial result1 = SymmPolyToValues.CyclicPolynomialBasisToPolynomial(allTerms, -10);
            LaurentPolynomial result2 = SymmPolyToValues.CyclicPolynomialBasisToPolynomial(allTerms, -15);
